...
DATASETS= {'pascal_voc': ('voc_2007_trainval',),'pascal_voc_0712': ('voc_2007_trainval+voc_2012_trainval',),'coin_banknote': ('train',)}

def vis_detections(im, class_name, dets, thresh=0.75):
...
def parse_args():
    ...
    parser.add_argument('--dataset', dest='dataset', help='Trained dataset [pascal_voc pascal_voc_0712]',
                        choices=DATASETS.keys(), default='coin_banknote')
